...
const makeTables = async () => {
    ...
    //
        ...
        */
        ...
        const bottledPutrescenceRecipe = await(createRecipe("Bottled Putrescence", bottledPutrescence, 5, alchemy, [[awakenedAir, 1], [awakenedDecay, 2], [draconicVial, 5], [hochenblume, 30]], null, "Air Potions", 3, 450, null, {Decayology: 1}, "Potion Experimentation", "Altar of Decay", "Learned via Potion Experimentation while having the Decayology specialization. Must be crafted at Altar of Decay.", [["Alchemical Catalyst", {PotionMastery: 30}], ["Lesser Illustrious Insight", {PotionLore: 25, AirFormulatedPotions: 30}]]));
        ...
        const delicateSuspensionOfSporesRecipe = await(createRecipe("Delicate Suspension of Spores", delicateSuspensionOfSpores, 5, alchemy, [[awakenedFrost, 1], [awakenedDecay, 1], [draconicVial, 5], [bubblePoppy, 10]], null, "Frost Potions", 1, 450, null, {Decayology: 1}, "Potion Experimentation", "Altar of Decay", "Learned via Potion Experimentation while having the Decayology specialization. Must be crafted at Altar of Decay.", [["Alchemical Catalyst", {PotionMastery: 30}], ["Lesser Illustrious Insight", {FrostFormulatedPotions: 30, PotionLore: 25}]]));
        ...
        const potionOfWitheringVitalityRecipe = await(createRecipe("Potion of Withering Vitality", potionOfWitheringVitality, 5, alchemy, [[awakenedFrost, 1], [awakenedDecay, 1], [draconicVial, 5], [writhebark, 10]], null, "Frost Potions", 1, 450, null, {Decayology: 1}, "Potion Experimentation", "Altar of Decay", "Learned via Potion Experimentation while having the Decayology specialization. Must be crafted at Altar of Decay.", [["Alchemical Catalyst", {PotionMastery: 30}], ["Lesser Illustrious Insight", {FrostFormulatedPotions: 30, PotionLore: 25}]]));
        ...
        const phialOfIcyPreservationRecipe = await(createRecipe("Phial of Icy Preservation", phialOfIcyPreservation, 2, alchemy, [[awakenedDecay, 1], [awakenedFrost, 1], [draconicVial, 2], [saxifrage, 9]], null, "Frost Phials", 1, 450, null, {Decayology: 1}, "Phial Experimentation", "Altar of Decay", "Learned via Phial Experimentation while having the Decayology specialization. Must be crafted at Altar of Decay.", [["Alchemical Catalyst", {PhialMastery: 30}], ["Lesser Illustrious Insight", {FrostFormulatedPhials: 30, PhialLore: 25}]]));
        const icedPhialOfCorruptingRageRecipe = await(createRecipe("Iced Phial of Corrupting Rage", icedPhialOfCorruptingRage, 2, alchemy, [[awakenedDecay, 1], [awakenedFrost, 1], [draconicVial, 2], [writhebark, 9]], null, "Frost Phials", 1, 450, null, {Decayology: 1}, "Phial Experimentation", "Altar of Decay", "Learned via Phial Experimentation while having the Decayology specialization. Must be crafted at Altar of Decay.", [["Alchemical Catalyst", {PhialMastery: 30}], ["Lesser Illustrious Insight", {FrostFormulatedPhials: 30, PhialLore: 25}]]));
